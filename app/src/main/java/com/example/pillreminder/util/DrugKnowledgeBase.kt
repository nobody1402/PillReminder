...
object DrugKnowledgeBase {
    ...
    private val rules: List<Pair<List<String>, DrugRuleSuggestion>> = listOf(
        ...
        listOf("استامینوفن", "پاراستامول", "تایلنول", "آپوتل", "apotel", "acetaminophen", "paracetamol") to
            DrugRuleSuggestion(
        ...
        listOf("بتامتازون", "betamethasone") to
            DrugRuleSuggestion(
                foodRelation = FoodRelation.WITH_FOOD,
                note = "این دارو (کورتیکواستروئید) معمولاً همراه غذا تجویز می‌شود تا کمتر معده را تحریک کند؛ دوز و مدت مصرف را دقیقاً طبق تجویز پزشک رعایت کنید.",
                englishName = "Betamethasone"
            ),
        listOf("سفازولین", "cefazolin") to
            DrugRuleSuggestion(
                foodRelation = null, fixedIntervalHours = 8,
                note = "این آنتی‌بیوتیک تزریقی معمولاً هر ۸ ساعت و طبق برنامه‌ی مشخص‌شده توسط پزشک/پرستار تزریق می‌شود.",
                englishName = "Cefazolin"
            ),
        listOf("کو آموکسی کلاو", "فارمنتین", "co-amoxiclav", "coamoxiclav", "augmentin") to
            DrugRuleSuggestion(
                foodRelation = FoodRelation.WITH_FOOD, fixedIntervalHours = 8,
                note = "برای کاهش ناراحتی گوارشی همراه غذا مصرف شود؛ هر ۸ ساعت و تا پایان دوره کامل ادامه یابد.",
                englishName = "Co-amoxiclav"
            ),
        listOf("سودوافدرین", "pseudoephedrine") to
            DrugRuleSuggestion(
                foodRelation = FoodRelation.NO_RELATION,
                note = "معمولاً فرقی با غذا ندارد؛ نزدیک به زمان خواب مصرف نشود چون ممکن است بی‌خوابی ایجاد کند.",
                englishName = "Pseudoephedrine"
            ),
